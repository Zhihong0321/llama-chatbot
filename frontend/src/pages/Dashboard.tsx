  ...
  return (
    <div className={styles.dashboard}>
      <header className={styles.header}>
        ...
        <div style={{ position: 'fixed', top: '10px', right: '10px', background: '#0000ff', color: 'white', padding: '5px 10px', borderRadius: '5px', zIndex: 9999, fontSize: '12px', fontWeight: 'bold' }}>
          BUILD: 2025-11-21-15:15 | INPUT-FIX-V5-REF
        </div>
      </header>
